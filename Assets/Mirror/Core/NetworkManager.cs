...
#pragma warning restore 618
        ...
        public void StopClient()
        {
            ...
            if (mode == NetworkManagerMode.Host)
                Disconnect_Server(NetworkServer.localConnection);
...
#pragma warning restore 618
        ...
        void RegisterServerMessages()
        {
            ...
            NetworkServer.OnDisconnectedEvent = Disconnect_Server;
        ...
        void FinishLoadSceneHost()
        {
            ...
            if (finishStartHostPending)
            {
                ...
                ChangeScene_Server(networkSceneName);
        ...
        public virtual void Connect_Server(NetworkConnectionToClient conn) { }

        /// <summary>Called on the server when a client disconnects.</summary>
        // Called by NetworkServer.OnTransportDisconnect!
        public virtual void Disconnect_Server(NetworkConnectionToClient conn)
        {
        ...
        public virtual void AddP_Server(NetworkConnectionToClient conn)
        {
        ...
        public virtual void StopGame_Client() { }

        /// <summary>This is called when a client is stopped.</summary>
        public virtual void OnStop_Client() { }
